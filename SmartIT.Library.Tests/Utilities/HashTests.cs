...
namespace SmartIT.Library.Tests.Utilities
{
	...
	public class HashTests
	{
		...
		[Test]
		public void Verify_GetCrc64Hash_EmptyString()
		{
			// Arrange

			// Act
			var result = Hash.GetCrc64Hash(emptyString);
		...
		[Test]
		public void Verify_GetCrc64Hash_EmptyStream()
		{
			// Arrange
			var buffer = Array.Empty<byte>();
			var memoryStream = new MemoryStream(buffer);
			...
			// Act
			var result = Hash.GetCrc64Hash(memoryStream);
		...
		public async Task<string> Verify_GetCrc64HashAsync_EmptyString()
		{
			// Arrange

			// Act
			var result = await Hash.GetCrc64HashAsync(emptyString);
		...
		[Test(ExpectedResult = "0000000000000000")]
		public async Task<string> Verify_GetCrc64HashAsync_EmptyStream()
		{
			// Arrange
			var buffer = Array.Empty<byte>();
			var memoryStream = new MemoryStream(buffer);
			...
			// Act
			var result = await Hash.GetCrc64HashAsync(memoryStream);
		...
		[Test]
		public void Verify_GetCrc64Hash_NotEmptyString()
		{
			// Arrange

			// Act
			var result = Hash.GetCrc64Hash(notEmptyString);

			// Assert
			Assert.That(result, Is.Not.Null);
			Assert.That(result, Has.Length.EqualTo(16));
			Assert.That(result, Is.EqualTo("2B7B3AD651233A91"));
		}

		[Test]
		public void Verify_GetCrc64Hash_NotEmptyStream()
		{
			// Arrange
			var buffer = Encoding.UTF8.GetBytes(notEmptyString);
			var memoryStream = new MemoryStream(buffer);
		...
		[Test(ExpectedResult = "2B7B3AD651233A91")]
		public async Task<string> Verify_GetCrc64HashAsync_NotEmptyString()
		{
			// Arrange

			// Act
			var result = await Hash.GetCrc64HashAsync(notEmptyString);
		...
		[Test(ExpectedResult = "2B7B3AD651233A91")]
		public async Task<string> Verify_GetCrc64HashAsync_NotEmptyStream()
		{
			// Arrange
			var buffer = Encoding.UTF8.GetBytes(notEmptyString);
			var memoryStream = new MemoryStream(buffer);
